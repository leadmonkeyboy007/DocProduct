...
setup(
    ...
    install_requires=['numpy', 'matplotlib', 'tensorflow==2.9.3', 'tensorflow-gpu==2.0.0-alpha0', 'Keras', 'keras-pos-embd==0.9.0', 'keras-transformer==0.21.0', 'tqdm', 'faiss', 'sklearn', 'pycurl', 'six', 'argparse'], 
    classifiers=(
